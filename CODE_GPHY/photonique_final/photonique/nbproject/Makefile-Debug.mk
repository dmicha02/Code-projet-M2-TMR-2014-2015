...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/photonique2.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/photonique2 ${OBJECTFILES} ${LDLIBSOPTIONS} -march=native
...
${OBJECTDIR}/Matching/EstimateRigidT.o: Matching/EstimateRigidT.cpp 
	${MKDIR} -p ${OBJECTDIR}/Matching
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Matching/EstimateRigidT.o Matching/EstimateRigidT.cpp

${OBJECTDIR}/Matching/TemplateMatching.o: Matching/TemplateMatching.cpp 
	${MKDIR} -p ${OBJECTDIR}/Matching
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Matching/TemplateMatching.o Matching/TemplateMatching.cpp
...
${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp

${OBJECTDIR}/matcher.o: matcher.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/matcher.o matcher.cpp
